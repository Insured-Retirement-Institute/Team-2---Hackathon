...
function getMockResponse(message: string): string {
  ...
  if (lower.includes("product") || lower.includes("myga")) return MOCK_RESPONSES.product;
  if (lower.includes("compare") || lower.includes("renewal") || lower.includes("option")) return MOCK_RESPONSES.compare;
  if (lower.includes("suitability") || lower.includes("suitable")) return MOCK_RESPONSES.suitability;
  if (lower.includes("client") || lower.includes("explain")) return MOCK_RESPONSES.client;
  if (lower.includes("rate") || lower.includes("interest")) return MOCK_RESPONSES.rate;
  if (lower.includes("compliance") || lower.includes("regulation")) return MOCK_RESPONSES.compliance;
