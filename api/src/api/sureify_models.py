...
#   timestamp: 2026-02-24T19:12:57+00:00
...
class ID(RootModel[constr(min_length=1, max_length=64)]):
    root: constr(min_length=1, max_length=64) = Field(
        ...
        examples=['4b33ae9e-827a-479d-b60c-8daa2873c08c'],
    )


class QuestionGroup(BaseModel):
    ID_1: ID | None = Field(
        None, alias='ID', description='A unique identifier for the question group.'
    )
...
class Question(BaseModel):
    ID_1: ID = Field(
        ..., alias='ID', description='A unique identifier for this question.'
    )
    title: constr(min_length=1, max_length=32767) = Field(
        ...,
        description='The text of the question.',
        examples=['What is your first name?'],
    )
...
class DateTime(RootModel[constr(min_length=4, max_length=36)]):
    root: constr(min_length=4, max_length=36) = Field(
        ...,
        ...
        examples=['2021-08-29T09:12:33.001Z'],
    )
...
class NonNegativePercent(RootModel[confloat(ge=0.0)]):
...
class Answer(BaseModel):
    answer: constr(min_length=1, max_length=32767) = Field(
        ..., description='An answer to a question.', examples=['John']
    )
...
class AnswerHistory(RootModel[list[AnswerHistoryItem]]):
    root: list[AnswerHistoryItem] = Field(
        ...,
...
class URL(BaseModel):
    ...
    name: constr(min_length=1, max_length=32767) | None = Field(
        ...
        examples=['LifetimeACQUIRE'],
    )
    URL: constr(min_length=1, max_length=32767) | None = Field(
        None,
        description='The URL (i.e. web address) of the external server, website, or application to which a user may be redirected.',
        examples=['https://dev-agent.sureify.com/'],
    )
...
class Product(BaseModel):
    ...
    ID_1: ID | None = Field(
        None, alias='ID', description='A unique identifier for this product.'
    )
...
class Type1(BaseModel):
    ...
    ID_1: ID | None = Field(
        None, alias='ID', description='A unique identifier for this group/type .'
    )
    name: constr(min_length=1, max_length=32767) | None = Field(
        None, description='The name of this group/type.', examples=['Life']
    )
...
class CasePolicyBase(BaseModel):
    ...
    ID_1: ID | None = Field(
        None, alias='ID', description='A unique identifier for this case or policy.'
    )
...
class NIGO(BaseModel):
    ...
    reason: constr(min_length=1, max_length=32767) | None = Field(
        ...
        examples=['Agent information is missing'],
    )
    category: constr(min_length=1, max_length=32767) | None = Field(
        None,
...
class Case(CasePolicyBase):
    ...
    NIGO_1: NIGO | None = Field(
        None, alias='NIGO', description='A summary of NIGO (Not In Good Order) state.'
    )
...
class Name(BaseModel):
    ...
    first: constr(min_length=1, max_length=32767) | None = Field(
        None, description='First name.', examples=['Bob']
    )
    last: constr(min_length=1, max_length=32767) | None = Field(
        None, description='Last name.', examples=['Smith']
    )
    middle: constr(min_length=1, max_length=32767) | None = Field(
        None, description='Middle name or initial.', examples=['J.']
    )
    suffix: constr(min_length=1, max_length=32767) | None = Field(
        None, description='Name suffix.', examples=['Jr.']
    )
...
class BaseEmail(BaseModel):
    ...
    emailAddress: constr(min_length=1, max_length=32767) | None = Field(
        None,
        description='The text of the email address.',
        examples=['info@sureify.com'],
    )
...
class BasePhoneNumber(BaseModel):
    ...
    phoneNumber: constr(min_length=1, max_length=50) | None = Field(
        None, description='A phone number', examples=['8558675309']
    )
...
class BaseAddress(BaseModel):
    ...
    address3: constr(min_length=1, max_length=32767) | None = Field(
        ...
        examples=['C/O Fred Rogers'],
    )
    city: constr(min_length=1, max_length=32767) | None = Field(
        None, description='A city name.', examples=['San Jose']
    )
...
class Person(BasePerson):
    ID_1: ID | None = Field(
        None, alias='ID', description='A unique identifier for this contact.'
    )
...
class BaseCompany(BaseModel):
    name: constr(min_length=1, max_length=32767) | None = Field(
        None, description='The name of the corporate entity.', examples=['SureCo']
    )
    addresses: list[Address] | None = Field(
        None,
        description='A collection of addresses for this person.',
    ...
    website: constr(min_length=1, max_length=32767) | None = Field(
        ...
        examples=['https://www.acme-co.com'],
    )
...
class Policy(CasePolicyBase):
    ...
    isSuspendIndicator: bool | None = Field(
        None,
        description='True indicates that the policy is Suspended.',
        examples=[True],
    )
...
class PayoutSchedule(BaseModel):
    ...
    type: constr(min_length=1, max_length=32767) | None = Field(
        ...
        examples=['systematic withdrawals'],
    )
...
class Annuity(Policy):
    ...
    excludableAmount: NonNegativeMonetaryAmount | None = Field(
        None,
        description='The amount of annuity payment that can be excluded from taxes using the annuitant’s exclusion allowance.',
    )
...
class Commission(BaseModel):
    ...
    comment: constr(min_length=1, max_length=32767) | None = Field(
        ...
        examples=['Bonus for 2023 Quarters 1 & 2.'],
    )
    description: constr(min_length=1, max_length=32767) | None = Field(
        ...
        examples=['Override on policies between 1/1/2022 - 3/31/2022.'],
    )
    ...
    status: str | None = Field(
        None,
        description='The status of the commission transaction',
        examples=['Pending'],
    )
...
class BaseTrust(BaseModel):
    ...
    name: constr(min_length=1, max_length=32767) | None = Field(
        None, description='The legal name of the trust.', examples=['SureCo']
    )
...
class BaseEstate(BaseModel):
    name: constr(min_length=1, max_length=32767) | None = Field(
        None,
        description='The legal name of the estate.',
        examples=['Estate of John Doe'],
    )
...
class BaseCharity(BaseModel):
    name: constr(min_length=1, max_length=32767) | None = Field(
        ...
        examples=['Helping Hands Foundation'],
    )
    addresses: list[Address] | None = Field(
        None,
...
class Document(BaseModel):
    ...
    ID_1: ID = Field(
        ..., alias='ID', description='A unique identifier for the document.'
    )
    title: constr(min_length=1, max_length=32767) | None = Field(
        None,
...
class Capability(RootModel[constr(min_length=1, max_length=32767)]):
    root: constr(min_length=1, max_length=32767) = Field(
        ...,
...
class Keycard(BaseModel):
    ...
    ID_1: ID | None = Field(
        None, alias='ID', description='A unique identifier for this keycard.'
    )
    contactID: ID | None = Field(
        None,
    ...
    ownerType: OwnerType | None = Field(
        None, description='The type of the keycard owner.', examples=['company']
    )
...
class Note(BaseModel):
    ...
    ID_1: ID | None = Field(
        None, alias='ID', description='A unique identifier for the note.'
    )
    policyID: ID | None = Field(
        None,
    ...
    title: constr(min_length=1, max_length=32767) | None = Field(
        ...
        examples=['Client signature required'],
    )
    content: constr(min_length=1, max_length=32767) | None = Field(
        None,
        description='The text that makes up the body of the `Note`.',
        examples=[
            'This application was received via paper and was missing signatures.  It has been returned for completion.'
        ],
    )
...
class BankAccountNumber(RootModel[constr(min_length=1, max_length=32767)]):
    root: constr(min_length=1, max_length=32767) = Field(
        ...,
        description='The account number for a bank account.',
        examples=['6541-5421-1564-8157'],
    )
...
class BankAccount(BaseModel):
    ...
    accountNumber: BankAccountNumber | None = Field(
        None, description='A masked bank account number.', examples=['***9054']
    )
...
class PaymentMethod1(BaseModel):
    ...
    ID_1: ID = Field(
        ..., alias='ID', description='A unique identifier for this payment method.'
    )
...
class ProposedClient(Person):
    ...
    heightInInches: confloat(ge=0.0) | None = Field(
        None, description="The `proposedClient`'s height in inches.", examples=[70.5]
    )
    weightInPounds: confloat(ge=0.0) | None = Field(
        None, description="The `proposedClient`'s weight in pounds.", examples=[195.5]
    )
...
class QuoteIllustrationBase(BaseModel):
    ...
    ID_1: ID | None = Field(
        None,
        alias='ID',
        description='A unique identifier for this quote or illustration.',
    )
...
class Requirement(BaseModel):
    ...
    ID_1: ID | None = Field(
        None, alias='ID', description='A unique identifier for this requirement.'
    )
    caseID: ID | None = Field(
        None,
...
class Rider(BaseModel):
    name: constr(min_length=1, max_length=255) | None = Field(
        ...
        examples=['Term Conversion Rider'],
    )
...
class BoundParty(BaseModel):
    ...
    ID_1: ID | None = Field(
        None,
        alias='ID',
        description='A pointer to the full contact record of this bound party.',
    )
...
class User(BaseModel):
    ...
    ID_1: ID | None = Field(
        None, alias='ID', description='A unique identifier for this user.'
    )
...
class LinkedParty(BaseModel):
    ...
    ID_1: ID | None = Field(
        None,
        alias='ID',
        description='A pointer to the full contact record of this linked party.',
    )
    partyNumber: constr(min_length=1, max_length=32767) | None = Field(
        None,
...
class GlobalSearchFields(RootModel[CaseSearchFields | PolicySearchFields]):
    root: CaseSearchFields | PolicySearchFields
...
class CompositeFilter(BaseModel):
    ...
    filters: list[
        ...
        | SearchFilter
        | ResourceTypeFilter
    ] = Field(..., max_length=32767, min_length=1)
...
class SearchResult(RootModel[PolicySearchResult | CaseSearchResult]):
    root: PolicySearchResult | CaseSearchResult = Field(
...
class UserLinkedPartySearchFields(
    RootModel[LinkedPartySearchFields | UserSearchFields]
):
    root: LinkedPartySearchFields | UserSearchFields
