...
class ProvideIndividualBeneficiaryDataBag(BasePerson):
    relationshipToInsured: RelationshipToInsured1 = Field(
        ...,
        description='The beneficiary’s relationship to the insured individual on the policy.',
    )
    name: Name
    DOB: DateTime = Field(
        ...,
